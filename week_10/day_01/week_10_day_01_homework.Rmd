...
# ~64% variation in the actual_length is explained by variation in the estimated_length (explanatory variable)
```
...
# outlier - observation which has a large residual
...
# which are outliers - 18, 31 & 5 have high residuals and leverage as they lie close to or outwith the dashed red lines (cook's distance). 
